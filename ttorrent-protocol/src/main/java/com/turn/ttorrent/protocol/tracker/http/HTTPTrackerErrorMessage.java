...
import com.turn.ttorrent.protocol.tracker.TrackerMessage.ErrorMessage;
...
public class HTTPTrackerErrorMessage extends HTTPTrackerMessage implements ErrorMessage {
    ...
    public static HTTPTrackerErrorMessage fromBEValue(@Nonnull Map<String, BEValue> params)
        ...
        try {
            String reason = params.get("failure reason").getString(BEUtils.BYTE_ENCODING);
    ...
    public Map<String, BEValue> toBEValue() {
        ...
        params.put("failure reason", new BEValue(getReason(), BEUtils.BYTE_ENCODING));
        return params;
    }
}